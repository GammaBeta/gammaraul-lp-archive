...
**Edit:** Regarding the difficulty, judging by the fact that the difficulty score is higher than 4, it's probably the case that the ratings bumped it down and not a mistake on my part. (I'm assuming that a score between 1 and 4 means it hasn't been altered by ratings and is how the creator marked the difficulty as.) <br>
